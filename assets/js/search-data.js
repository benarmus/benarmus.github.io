...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "post-an-embarrassing-confession",
        
          title: 'An Embarrassing Confession <svg width="1.2rem" height="1.2rem" top=".5rem" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><path d="M17 13.5v6H5v-12h6m3-3h6v6m0-6-9 9" class="icon_svg-stroke" stroke="#999" stroke-width="1.5" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
        
        description: "Could this be the &quot;most important moment in history?&quot;",
        section: "Posts",
        handler: () => {
          
            window.open("https://benarmus.substack.com/p/an-embarrassing-confession", "_blank");
          
        },
      },{id: "post-the-cambridge-platonists-and-eternal-hell",
        
          title: 'The Cambridge Platonists and Eternal Hell <svg width="1.2rem" height="1.2rem" top=".5rem" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><path d="M17 13.5v6H5v-12h6m3-3h6v6m0-6-9 9" class="icon_svg-stroke" stroke="#999" stroke-width="1.5" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
        
        description: "The Case against infernalism, then and now",
        section: "Posts",
        handler: () => {
          
            window.open("https://benarmus.substack.com/p/the-cambridge-platonists-and-eternal", "_blank");
